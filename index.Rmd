...
Here is the link to my GitHub STATS220 repository: https://github.com/dwoo7/stats220

For now, I have shared code, a link to a website for my stats220 repo, some photos, a GIF file and explanations about the meme I have created.
I will continue to share assignments and other work related to STATS220 in the future.

## Animated GIF Creation

When we were assigned to create a unique GIF, I immediately thought of a jump scare. The worms in the frames of the GIF were drawn up by me using pixel art websites and I added a 'scare' at the end. After scaring some of my friends - some a little too much - I changed the final photo and gave a little heads up so that no one gets too frightened. It was really interesting playing around with the movements of the worm and adding backgrounds to give the GIF a little more substance.

Here is the code I used to generate the GIF:

```{r setup, include=TRUE, echo=TRUE}
knitr::opts_chunk$set(echo = TRUE, message = FALSE)
```

```{r worm, include=TRUE, echo=TRUE}
...
In Module 1, Creating HTML by combining modern technologies, there were many key concepts that were taught.
An important idea that I learned from this module was using Rmarkdown and the magick package to create interesting web pages and GIFs.
I have only created webpages using e-commerce so it felt great to make my own blog-styled page. I also made GIFs in the past using different websites but was limited to videos and live photos. I was shocked how simple it was to create my own GIFs that went beyond previous limitations.
As the concept is very interesting, I have been looking up ways to add sound to animations. I may have to update this GIF in the future!

Data technology is an extremely wide field and I would like to explore how we can apply the knowledge from making GIFs to data visualisation. Data visualisation was, and is, a common theme in my projects. I only worked with static graphs and plots in the past, and it would be great to be able to integrate knowledge from this course to create interactive and/or plots with animation in the future as I believe it would be an effective method to show change over time.